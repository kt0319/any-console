 ...
 */
export function isEditableTarget(el: HTMLElement | null | undefined): boolean {
  if (!el) return false;
 ...
 */
export function isEditableOrDialogTarget(el: HTMLElement | null) {
  if (!el) return false;
 ...
 */
export function restartTapBounce(el: HTMLElement) {
