 ...
 */
export function devServerOrigin(entry: { scheme?: string; proxy_port?: number } | null | undefined, hostname: string): string {
 ...
 */
export function devServerUrl(entry: { scheme?: string; proxy_port?: number } | null | undefined, hostname: string): string {
