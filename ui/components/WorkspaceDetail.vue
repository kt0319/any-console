...
const tabs = computed(() => {
  ...
  const list: WorkspaceTabDef[] = [
    ...
    { key: "issues", icon: "mdi-ticket-confirmation-outline", label: "Issues", count: issuesCount.value || 0, showCount: false, iconColor: issuesCount.value ? "#f5a623" : undefined, hidden: !isGit || !hasGitHub.value || !issuesCount.value },
