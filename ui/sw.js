const CACHE_NAME = 'pi-console-v2';
const ASSETS_TO_CACHE = [
  ...
  './utils.js',
  './auth.js',
  './terminal-connection.js',
  './terminal-view-mode.js',
  './terminal-split.js',
  './terminal-tab-pill.js',
  './terminal-tabs.js',
  './terminal-tab-modal-workspace.js',
  './terminal-tab-modal.js',
  './terminal.js',
  './quick-input-keys.js',
  './quick-input.js',
  './workspace.js',
  './file-browser-upload.js',
  './git-file-browser.js',
  './git-diff.js',
  './git.js',
  './git-log-modal.js',
  './git-log-history.js',
  './git-log-branch-stash.js',
  './icon-picker.js',
  './job-form.js',
  './jobs.js',
  './settings-workspace.js',
  './settings-terminal.js',
  './settings.js',
  './viewport.js',
  './bootstrap.js',
