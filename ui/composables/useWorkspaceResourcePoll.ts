...
export function createWorkspaceResourcePoll({ resourcePath, mapItem }: {
  ...
  return function useWorkspaceResourcePoll() {
    ...
    function stopPolling(workspace: string) {
      if (!workspace) return;
