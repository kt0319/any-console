...
function isFrameVisible(tab: TerminalTab) {
...
export function fitTerminal(tab: TerminalTab | null | undefined, opts: { force?: boolean, scrollToBottom?: boolean } = {}) {
...
export function sendResize(tab: TerminalTab | null | undefined) {
...
export function observeFrameResize(tab: TerminalTab, frameEl: Element) {
