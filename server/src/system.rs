...
async fn get_tailscale_info(trust_enabled: bool) -> Option<Value> {
    ...
    let https_enabled = std::env::var("SSL_KEYFILE").is_ok_and(|v| !v.is_empty())
        && std::env::var("SSL_CERTFILE").is_ok_and(|v| !v.is_empty());
